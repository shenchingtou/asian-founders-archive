...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/asian-founders-archive/flexsearch.min.js');loadScript('/asian-founders-archive/en.search-data.min.0079ac66cbcd79813db03c0e9e02b9fba0b4ff9f1b8a99cc076c2f2c9731cd11.js',function(){input.required=false;search();});}
