...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/asian-founders-archive/flexsearch.min.js');loadScript('/asian-founders-archive/en.search-data.min.41772d56161c6b79821f68511ac3364f709b3100a78aa60de8ef791dccc4835f.js',function(){input.required=false;search();});}
