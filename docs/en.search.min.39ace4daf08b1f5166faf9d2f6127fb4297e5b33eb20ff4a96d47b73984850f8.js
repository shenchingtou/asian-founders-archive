...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/asian-founders-archive/flexsearch.min.js');loadScript('/asian-founders-archive/en.search-data.min.e5c0a2878e1c755f612654d59aebcf8b32566bfb782794dbcb6e42408833673a.js',function(){input.required=false;search();});}
