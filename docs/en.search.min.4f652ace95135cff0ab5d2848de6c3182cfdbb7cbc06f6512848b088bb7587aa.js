...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/asian-founders-archive/flexsearch.min.js');loadScript('/asian-founders-archive/en.search-data.min.d92d02349107303e655e6a1abec5a061af4dd5cb39fe13b7fad321c8abbacae6.js',function(){input.required=false;search();});}
