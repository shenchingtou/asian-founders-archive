...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/asian-founders-archive/flexsearch.min.js');loadScript('/asian-founders-archive/en.search-data.min.f7c93f2ed76e427db925f5bc490ed91a4996bd8e84c3d69414d3ac84186d0b6a.js',function(){input.required=false;search();});}
