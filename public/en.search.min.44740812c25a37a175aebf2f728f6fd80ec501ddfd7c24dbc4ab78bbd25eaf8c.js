...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ae9b35532bdd12cf5bd0b4bac2e10acfd328fada9bb873c9dd8eced4edb3f30e.js',function(){input.required=false;search();});}
